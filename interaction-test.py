...
# Ubah konteks untuk bahasa Indonesia
context = "Kamu adalah Nathan, seorang ahli sejarah Indonesia. Kamu cerdas dan memiliki kepribadian menarik. Jawabanmu harus singkat, maksimal 1-2 kalimat."
...
def request_gpt(prompt: str) -> str:
    # # Format pesan untuk GPT
    # messages = [
    #     HumanMessage(content=prompt)
    # ]
    
    # # Memanggil OpenAI LLM melalui LangChain
...
def introduction():
    ...
    audio = elevenlabs.generate(text=intro_text, voice="Charlie", model="eleven_monolingual_v1")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        audio = elevenlabs.generate(
            text=response, voice="Charlie", model="eleven_monolingual_v1"
        )
